...
import { changeHeadshot } from '../../../axios/iframe'
import { isUserHeadshot } from '../../../function/user'
import { leftHeight } from '../../../function/Window/window'
const previews = ref({})
...
const updateAvatar = async () => {
  cropper.value.getCropBlob(async (blob) => {
    ...
    //发送请求
    await changeHeadshot(avatar)
  })
}
</script>
<template>
  <div v-show="isUserHeadshot" class="wrapper">
    <div class="top">
      <button class="close-button" @click="isUserHeadshot = false">退出</button>
    </div>
    <div class="main">
